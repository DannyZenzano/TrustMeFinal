...
public class ComprarFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("LOGDANNY:ComprarFragmento:OnCREATE");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        System.out.println("LOGDANNY:ComprarFragmento:OnCREATEVIEW");
        View vista = inflater.inflate(R.layout.fragment_comprar, container, false);
        ListaTransacciones=new ArrayList<transacciones>();
        ListaKeyTransacciones=new ArrayList<String>();
        recyclerTransactions= (RecyclerView) vista.findViewById(R.id.recyclerIdComprar);
        ...
        final AdapterPurchase adapter = new AdapterPurchase(ListaTransacciones,this);
        ...
        adapter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //IR A VER COMPRA, LE ENVIO EL ID DE LA COMPRA Y EL OBJETO TRANSACCION
                //Vuelvo a pagina de registro o logueo
                Intent intent = new Intent(getActivity(), VerCompraActivity.class);
                ...
                intent.putExtra("Estado_transaccion",ListaTransacciones.get(posicionclick).getTr_id_vendedor());
        ...
        System.out.println("LOGDANNY:ComprarFragmento:OnCREATEVIEW:CREANDO BASE DE DATOS");
        ...
        Query query_get_unique_user = mDatabase.orderByChild("tr_id_comprador").equalTo(miuid);
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
            ...
            Toast.makeText(context, "COMPRAR Fragment Attached", Toast.LENGTH_SHORT).show();
        }
    }
